                    ...
                    <div className={`absolute inset-0 flex items-center justify-between px-4 transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] ${isExpanded ? 'opacity-0 scale-50 pointer-events-none' : 'opacity-100 scale-100'}`}>
                        ...
                        <div className="relative -my-2">
                            <button
                                ...
                                className="w-18 h-18 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 border border-gray-200/50 hover:bg-gray-50 transition-all duration-300 flex items-center justify-center group shadow-[0_4px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_6px_25px_rgba(0,0,0,0.15)]"
                            >
