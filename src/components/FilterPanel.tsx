  ...
  return (
    <div className="animate-fadeIn relative">
      ...
      {showFilters && createPortal(
        <div ref={panelRef} className="fixed right-0 z-[9999] bg-white rounded-xl shadow-md p-3 sm:p-4 mt-2 border border-gray-100 w-72" style={{ top: 'calc(var(--filter-button-height, 40px) + var(--filter-button-top, 0px))', right: 'var(--filter-button-right, 16px)' }}>
